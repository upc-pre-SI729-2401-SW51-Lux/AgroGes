...
|----|-------|----|-------|-------------|-------------------|-------------|--------|
| T01 | Explorar la página de Inicio | W01 | Estilos adecuados de la landing page siguiendo las buenas practicas | En este task Id  | Gustavo Poma, Favio Landeo | 1 | Done |
