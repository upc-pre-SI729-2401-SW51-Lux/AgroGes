...
| EPIC005 | Asesoramiento en Control de Calidad y Prevención de Amenazas | Como consultor agrícola, deseo proporcionar asesoramiento especializado a los agricultores para mejorar la calidad de sus productos y prevenir amenazas. |||
...
| EPIC007 | Desarrollo de una API REST para la gestión de la agricultura |Como desarrollador,
Quiero construir una API REST completa para la gestión de la agricultura,
Para que los agricultores y las empresas puedan gestionar eficientemente sus operaciones agrícolas. |||
| US001 | Definir Objetivos de Rendimiento | Como agricultor, deseo definir objetivos de rendimiento para mis cultivos, para poder medir y mejorar mi productividad. | 1. Dado que el usuario desea definir objetivos de rendimiento, cuando el usuario ingresa los objetivos en el sistema, entonces el sistema permite al usuario definir objetivos de rendimiento. 2. Dado que el usuario ha definido los objetivos de rendimiento, cuando el usuario consulta los objetivos, entonces el sistema muestra los objetivos de rendimiento definidos por el usuario. 3. Dado que el usuario ha definido los objetivos de rendimiento, cuando el usuario realiza seguimiento de los objetivos, entonces el sistema registra el progreso hacia los objetivos de rendimiento. | EPIC001 |
| US002 | Adaptar Estrategia de Cultivo | Como agricultor, deseo adaptar mi estrategia de cultivo según los cambios en el entorno o las condiciones climáticas, para poder maximizar la productividad de mis cultivos. | 1. Dado que el usuario desea adaptar su estrategia de cultivo, cuando el usuario realiza cambios en su estrategia en el sistema, entonces el sistema permite al usuario adaptar su estrategia de cultivo. 2. Dado que el usuario ha adaptado su estrategia de cultivo, cuando el usuario consulta su estrategia, entonces el sistema muestra la estrategia de cultivo adaptada por el usuario. 3. Dado que el usuario ha adaptado su estrategia de cultivo, cuando el usuario realiza seguimiento de su estrategia, entonces el sistema registra el impacto de la estrategia adaptada en la productividad de los cultivos. | EPIC001 |
| US003 | Seguimiento de Actividades Agrícolas | Como agricultor, deseo realizar un seguimiento detallado de las actividades agrícolas diarias, para poder analizar y optimizar mis procesos. | 1. Dado que el usuario desea realizar un seguimiento de sus actividades agrícolas, cuando el usuario registra sus actividades en el sistema, entonces el sistema permite al usuario realizar un seguimiento de sus actividades agrícolas. 2. Dado que el usuario ha registrado sus actividades agrícolas, cuando el usuario consulta sus actividades, entonces el sistema muestra un resumen de las actividades agrícolas realizadas por el usuario. 3. Dado que el usuario ha registrado sus actividades agrícolas, cuando el usuario analiza sus actividades, entonces el sistema proporciona análisis y recomendaciones para optimizar los procesos agrícolas. | EPIC001 |
| US004 | Monitorear Calidad de Productos | Como agricultor, deseo monitorear la calidad de mis productos para asegurar que cumplen con los estándares requeridos. | 1. Dado que el usuario desea monitorear la calidad de sus productos, cuando el usuario registra los datos de calidad en el sistema, entonces el sistema permite al usuario monitorear la calidad de sus productos. 2. Dado que el usuario ha registrado los datos de calidad de sus productos, cuando el usuario consulta los datos de calidad, entonces el sistema muestra los datos de calidad de los productos del usuario. 3. Dado que el usuario ha registrado los datos de calidad de sus productos, cuando el usuario compara los datos de calidad con los estándares requeridos, entonces el sistema proporciona un informe de cumplimiento de los estándares de calidad. | EPIC002 |
| US005 | Acceso a Mejores Prácticas Agrícolas | Como agricultor, deseo tener acceso a información actualizada sobre las mejores prácticas agrícolas para mejorar la calidad de mis productos. | 1. Dado que el usuario desea tener acceso a las mejores prácticas agrícolas, cuando el usuario consulta esta información en el sistema, entonces el sistema proporciona al usuario acceso a información actualizada sobre las mejores prácticas agrícolas. 2. Dado que el usuario ha consultado información sobre las mejores prácticas agrícolas, cuando el usuario aplica estas prácticas, entonces el sistema registra las prácticas agrícolas aplicadas por el usuario. 3. Dado que el usuario ha aplicado las mejores prácticas agrícolas, cuando el usuario realiza seguimiento de la calidad de sus productos, entonces el sistema muestra el impacto de las mejores prácticas agrícolas en la calidad de los productos. | EPIC002 |
| US006 | Predecir y Prevenir Amenazas | Como agricultor, deseo predecir y prevenir posibles amenazas a mis cultivos para reducir las pérdidas. | 1. Dado que el usuario desea predecir posibles amenazas a sus cultivos, cuando el usuario consulta estas amenazas en el sistema, entonces el sistema permite al usuario predecir posibles amenazas a sus cultivos. 2. Dado que el usuario ha predicho posibles amenazas a sus cultivos, cuando el usuario toma medidas para prevenir estas amenazas, entonces el sistema registra las acciones del usuario para prevenir las amenazas predichas. 3. Dado que el usuario ha tomado medidas para prevenir las amenazas predichas, cuando el usuario realiza seguimiento de la salud de sus cultivos, entonces el sistema muestra el impacto de las medidas preventivas en la salud de los cultivos. | EPIC003 |
| US007 | Recibir Alertas Climáticas | Como agricultor, deseo recibir alertas sobre condiciones climáticas adversas, para poder tomar medidas preventivas y proteger mis cultivos. | 1. Dado que el usuario desea recibir alertas climáticas, cuando el sistema detecta condiciones climáticas adversas, entonces el sistema envía alertas al usuario. 2. Dado que el usuario ha recibido alertas climáticas, cuando el usuario toma medidas preventivas, entonces el sistema registra las medidas preventivas tomadas por el usuario. 3. Dado que el usuario ha tomado medidas preventivas, cuando el usuario realiza seguimiento de la salud de sus cultivos, entonces el sistema muestra el impacto de las medidas preventivas en la salud de los cultivos. | EPIC003 |
| US008 | Asesoramiento en Objetivos de Rendimiento | Como consultor agrícola, deseo asesorar a los agricultores en la definición de objetivos de rendimiento para sus cultivos. | 1. Dado que el consultor desea asesorar en la definición de objetivos de rendimiento, cuando el consultor proporciona asesoramiento, entonces el sistema registra el asesoramiento proporcionado. 2. Dado que el consultor ha proporcionado asesoramiento, cuando el agricultor consulta el asesoramiento, entonces el sistema muestra el asesoramiento proporcionado por el consultor. 3. Dado que el consultor ha proporcionado asesoramiento, cuando el agricultor aplica el asesoramiento, entonces el sistema registra el impacto del asesoramiento en los objetivos de rendimiento del agricultor. | EPIC004 |
| US009 | Asesoramiento en Estrategias de Cultivo | Como consultor agrícola, deseo asesorar a los agricultores en la adaptación de su estrategia de cultivo según los cambios en el entorno o las condiciones climáticas. | 1. Dado que el consultor desea asesorar en la adaptación de estrategias de cultivo, cuando el consultor proporciona asesoramiento, entonces el sistema registra el asesoramiento proporcionado. 2. Dado que el consultor ha proporcionado asesoramiento, cuando el agricultor consulta el asesoramiento, entonces el sistema muestra el asesoramiento proporcionado por el consultor. 3. Dado que el consultor ha proporcionado asesoramiento, cuando el agricultor aplica el asesoramiento, entonces el sistema registra el impacto del asesoramiento en la estrategia de cultivo del agricultor. | EPIC004 |
| US010 | Asesoramiento en Control de Calidad | Como consultor agrícola, deseo asesorar a los agricultores en el monitoreo de la calidad de sus productos. | 1. Dado que el consultor desea asesorar en el control de calidad, cuando el consultor proporciona asesoramiento, entonces el sistema registra el asesoramiento proporcionado. 2. Dado que el consultor ha proporcionado asesoramiento, cuando el agricultor consulta el asesoramiento, entonces el sistema muestra el asesoramiento proporcionado por el consultor. 3. Dado que el consultor ha proporcionado asesoramiento, cuando el agricultor aplica el asesoramiento, entonces el sistema registra el impacto del asesoramiento en la calidad de los productos del agricultor. | EPIC005 |
| US011 | Asesoramiento en Prevención de Amenazas | Como consultor agrícola, deseo asesorar a los agricultores en la predicción y prevención de posibles amenazas a sus cultivos. | 1. Dado que el consultor desea asesorar en la prevención de amenazas, cuando el consultor proporciona asesoramiento, entonces el sistema registra el asesoramiento proporcionado. 2. Dado que el consultor ha proporcionado asesoramiento, cuando el agricultor consulta el asesoramiento, entonces el sistema muestra el asesoramiento proporcionado por el consultor. 3. Dado que el consultor ha proporcionado asesoramiento, cuando el agricultor aplica el asesoramiento, entonces el sistema registra el impacto del asesoramiento en la prevención de amenazas a los cultivos del agricultor. | EPIC005 |
...
- Agricultores:
   ...
   - User Goal: Ingresar a la página principal de la Aplicación Web como usuario agricultor.
	...
	![image](https://github.com/upc-pre-SI729-2401-SW51-Lux/AgroGes/assets/102195498/4dadca35-6290-465d-8b0f-0d6c03e331c1)
   ...
   - User Goal: Agregar un cultivo a la planificación del agricultor.
	...
	![image](https://github.com/upc-pre-SI729-2401-SW51-Lux/AgroGes/assets/102195498/b45401ba-2344-4ce3-bbb3-4f8b44bb19a0)
